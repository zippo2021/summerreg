...
class UserData(models.Model):
    ...
    parent_1_phone  = models.PositiveIntegerField(verbose_name='Телефон родителя 1',max_length=12)  
    parent_2 = models.CharField(verbose_name='Фамилия Имя Отчество родителя 2',  max_length=255,blank=True, null=True)
    parent_2_phone = models.PositiveIntegerField(verbose_name='Телефон родителя 2',max_length=12,blank=True, null=True)
